...
function extractInformationIntoType(
	...
	// Image URL
	// If file array is not empty, get the URL, else it is null
	const imageURL: string | null = (projFromNotion.image.files.length !== 0) 
									? projFromNotion.image.files[0].file.url 
									: null;
	// Technologies
