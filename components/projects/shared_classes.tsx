export const topSectionClasses = "w-full mt-4 mb-8 flex gap-2";

export const searchClasses =
	"w-3/4 max-w-sm bg-transparent border-2 border-slate-800 h-12 py-2 px-4 rounded-full focus:outline-none focus:ring-0 ";

export const projectGridClasses =
